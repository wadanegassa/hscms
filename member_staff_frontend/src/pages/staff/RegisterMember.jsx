...
export default function RegisterMember() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ fullName: '', email: '', password: '', phone: '', nationalId: '', occupation: '', organizationName: '', paymentMethod: 'cbe', accountNumber: '' });
    } catch (err) {
            ...
            {formData.occupation && (
              <div className="input-group">
                <label className="label">
                  {formData.occupation === 'Government Employee' ? 'Ministry / Organization Name' :
                    formData.occupation === 'Farmer' ? 'Farm Location / Association' :
                      'Business Name'}
                </label>
                <input
                  type="text"
                  ...
                  required
                  placeholder={
                    formData.occupation === 'Government Employee' ? 'e.g. Ministry of Education' :
                      formData.occupation === 'Farmer' ? 'e.g. Harar Farmers Union' :
                        'e.g. My Small Shop'
                  }
                  className="input"
                />
