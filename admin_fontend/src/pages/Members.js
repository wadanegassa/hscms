            ...
            <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem' }}>
                <div>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', marginTop: '0.5rem' }}>
                        Manage and monitor your community of members.
                    </p>
                </div>

                <div style={{ display: 'flex', gap: '1rem' }}>
                    <div className="search-container" style={{ width: 400, background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)', borderRadius: '16px' }}>
            ...
            <div className="table-container" style={{ padding: 0, overflow: 'hidden', borderRadius: '24px', border: '1px solid var(--border)' }}>
                {loading ? (
                    <div className="loading-container" style={{ padding: '6rem' }}>
                        ...
                        <div style={{ color: 'var(--text-muted)', marginTop: '1.5rem' }}>Syncing member records...</div>
                    </div>
                ) : (
                        ...
                        <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0 }}>
                            <thead>
                                <tr style={{ background: 'rgba(255,255,255,0.02)' }}>
                                    <th style={{ padding: '1.5rem', textAlign: 'left', color: 'var(--text-muted)', fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Member Profile</th>
                                    <th style={{ padding: '1.5rem', textAlign: 'left', color: 'var(--text-muted)', fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Financials</th>
                                    <th style={{ padding: '1.5rem', textAlign: 'left', color: 'var(--text-muted)', fontSize: '0.75rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>Verification</th>
                                ...
                                {filteredMembers.length === 0 ? (
                                    <tr>
                                        <td colSpan="5" style={{ textAlign: 'center', padding: '6rem', color: 'var(--text-muted)' }}>
                                            ...
                                            <div style={{ fontSize: '1.1rem' }}>No members match your criteria.</div>
                                        </td>
                                    </tr>
                                ) : (
                                            ...
                                            <td style={{ padding: '1.5rem' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                        <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontWeight: 700, textTransform: 'uppercase' }}>Savings:</span>
                                                        <span style={{ fontWeight: 800, color: 'var(--primary)' }}>{(u.totalSaved || 0).toLocaleString()} <span style={{ fontSize: '0.7rem', opacity: 0.5 }}>ETB</span></span>
                                                    </div>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                                        <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontWeight: 700, textTransform: 'uppercase' }}>Loan:</span>
                                                        <span style={{ fontWeight: 800, color: u.activeLoan ? 'var(--warning)' : 'var(--text-muted)' }}>
                                                            {u.activeLoan ? `${u.activeLoan.amount.toLocaleString()} ETB` : 'None'}
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td style={{ padding: '1.5rem' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '0.85rem' }}>
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--text-secondary)' }}>
                                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="4" width="18" height="16" rx="2" /><line x1="7" y1="8" x2="17" y2="8" /><line x1="7" y1="12" x2="17" y2="12" /><line x1="7" y1="16" x2="12" y2="16" /></svg>
                                                        {u.nationalId || 'No ID'}
                                                    </div>
                    ...
                    <div className="glass-card scale-up" onClick={(e) => e.stopPropagation()} style={{ width: '100%', maxWidth: '500px', padding: '2.5rem', border: '1px solid var(--border)' }}>
                        ...
                        <form onSubmit={handleEdit} style={{ display: 'grid', gap: '1.5rem' }}>
                            {[
                                ...
                                { label: 'National ID', key: 'nationalId', type: 'text', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="4" width="18" height="16" rx="2" /><line x1="7" y1="8" x2="17" y2="8" /><line x1="7" y1="12" x2="17" y2="12" /><line x1="7" y1="16" x2="12" y2="16" /></svg> },
                                { label: 'Bank Account (CBE)', key: 'bankAccount', type: 'text', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11M20 10v11M8 14v3M12 14v3M16 14v3" /></svg> },
                                { label: 'Telebirr', key: 'telebirr', type: 'text', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="5" y="2" width="14" height="20" rx="2" ry="2" /><line x1="12" y1="18" x2="12.01" y2="18" /></svg> }
                            ].map(field => (
                                <div key={field.key}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
                                ...
                                <button type="submit" className="btn hover-glow" disabled={submitting} style={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '0.75rem',
